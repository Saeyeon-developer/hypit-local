          ...
          { name: "recipe", kind: "reference", required: true, accepts: [svsRecipeType],
            ...
            recipe: [
              ...
              { name: "max-words-per-line", required: false,
                summary: "Optional counted row breaks between complete alignment units. Counts display Words, normally individual characters in Chinese and eojeol in Korean; preserves Cues. Omit for width-based flow." },
              ...
              { name: "word-gap", required: false, fallback: "a quarter of size",
                summary: "Sets pixel spacing between Latin words and at Chinese/Latin boundaries. Adjacent Han characters and full-width punctuation have no extra word gap; Korean eojeol remain whole display words; use letter-spacing for tracking." },
              ...
              { name: "karaoke-transition", required: false, values: ["step", "wipe"], fallback: "step",
                summary: "step activates each whole timed unit at its start (normally one Han character in Chinese or one Korean eojeol); wipe sweeps inside that unit's glyphs during its own interval." },
